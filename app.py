...
if st.session_state.admin_mode:
    with tab5:
        ...
        # === BOTÓN GUARDAR CON CONFIRMACIÓN (modal) ===
        if "confirmar_guardado" not in st.session_state:
            st.session_state.confirmar_guardado = False

        # Mostrar feedback de un guardado previo (se ejecuta y luego rerun).
        ...
        def _solicitar_confirmacion():
            """Valida y, si todo está bien, abre el modal de confirmación."""
